...
namespace social_navigation_layers
{
  class SocialLayer : public costmap_2d::Layer
  {
    ...
    protected:
      ...
      people_msgs::People people_list_; // people information
      people_msgs::People group_people_list_; // group of people information
      people_msgs::People object_people_list_; // human object interaction information
      std::list<people_msgs::Person> transformed_people_;
      std::list<people_msgs::Person> transformed_group_people_;
      std::list<people_msgs::Person> transformed_object_people_;
      ros::Duration people_keep_time_;
      boost::recursive_mutex lock_;
      //tf::TransformListener tf_; -- Close by Tien
      bool first_time_;
