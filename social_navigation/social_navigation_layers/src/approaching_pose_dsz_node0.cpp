...
ros::Publisher human_group_pub;// publish "human_group" to local_costmap
...
geometry_msgs::Pose2D selectApproachingHumans(gazebo_msgs::ModelStates human_states, std_msgs::Int8 goal_index){
    ...
    for(int i = 0; i<human_states.name.size(); i++)
    {
        ...
        {        
            ...
            if(human_states.name[i] == "actor1" || human_states.name[i] == "actor2" || human_states.name[i] == "actor3" || human_states.name[i] == "female")
            {
                shgroup.x = human_states.pose[i].position.x;
                shgroup.y = human_states.pose[i].position.y;
...
//II.7====================================================================================//
std::vector <geometry_msgs::Point> subFilterApproachingAreasByFiewOfView(std::vector <geometry_msgs::Point> approaching_areas, geometry_msgs::Quaternion quat_in,geometry_msgs::Point hp, string name)
{
...
//II.8====================================================================================//
std::vector <geometry_msgs::Point> filterApproachingAreasByFiewOfView(std::vector <geometry_msgs::Point> approaching_areas, gazebo_msgs::ModelStates human_states, std_msgs::Int8 goal_index ){
    int8_t ind;
    ind = goal_index.data;
    std::vector <geometry_msgs::Point> approaching_areas_fov;
...
int main(int argc, char **argv)
{
    ...
    human_group_pub = nh.advertise<geometry_msgs::Pose2D>("/human_group_info", 10);// human_group_info pub to local_costmap to add layers
