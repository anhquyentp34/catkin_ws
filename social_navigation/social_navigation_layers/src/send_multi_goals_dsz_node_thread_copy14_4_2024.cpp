...
//
 ...
 ros::Subscriber moving_robot_commad_sub;
...
// landmarks_pose: [x, y,  z w] represent via quaternion
 // Original_Tien/*
// double_t landmarks_pose[N_GOALS][4] = {{0.945546233456496, 4.844177606842447, 0.9757793662882653, 0.2187570074892383}, {1.857125583330584, 5.351967386235168, 0.2774615212998381, 0.9607367507272632}, {6.696751552865482, 2.332338853660102, 0.016696672699354414, 0.999860600844323},
...
double_t landmarks_pose[N_GOALS][4] = {{0.945546233456496, 4.844177606842447, 0.9757793662882653, 0.2187570074892383}, {1.857125583330584, 5.351967386235168, 0.2774615212998381, 0.9607367507272632}, {5.379121574817534, 2.407937026259673, 0.00592567253761282, 0.9999805748152029},
                                       {5.280866581849011,-1.1399355679074732, -0.6918911709326544, 0.7220018058048334}, {6.972651073014089, -4.603245977323878, -0.5566936207707035, 0.8307178898959647}, {3.8429206531658955, -7.746525935356161, -0.9742618110405334, 0.22541943915292642},
                                       {-1.7296581091340602,-7.6707138250513385, 0.9930704503662334, 0.1175205539869785}, {-6.741427001424995, -7.890714071782519, 0.9997861699247933, 0.020678840081402763}, {-5.286867013274685, -3.682149454960467, -0.9943849600700378, 0.10582320722086112},
                                       {-8.864045540438656, 2.047309735095137, -0.0070359868513256586, 0.9999752471381619}};

// // position of deteced humans
// double_t landmarks_pose[N_GOALS][4] = {{0.945546233456496, 4.844177606842447, 0.9757793662882653, 0.2187570074892383}, {4.1610276949830665, 6.440141273188676, 0.008298503988575642, 0.999965566822954},  {8.383250210526915, 2.379913828914083, -0.7005589020122529, 0.7135945801440771},
//                                        {5.280866581849011,-1.1399355679074732, -0.6918911709326544, 0.7220018058048334}, {6.972651073014089, -4.603245977323878, -0.5566936207707035, 0.8307178898959647}, {3.8429206531658955, -7.746525935356161, -0.9742618110405334, 0.22541943915292642},
//                                        {-1.7296581091340602,-7.6707138250513385, 0.9930704503662334, 0.1175205539869785}, {-6.741427001424995, -7.890714071782519, 0.9997861699247933, 0.020678840081402763}, {-5.286867013274685, -3.682149454960467, -0.9943849600700378, 0.10582320722086112},
//                                        {-8.864045540438656, 2.047309735095137, -0.0070359868513256586, 0.9999752471381619}};
...
void approaPoseCommandCallback(std_msgs::Bool msg)
{
 ...
 //
void movingRobotCommandCallback(std_msgs::Bool msg)
{
    if (msg.data == true)
    {
        counter = 2;
...
int main(int argc, char** argv)
{
  ...
  // goal_index_pub = nh.advertise<std_msgs::Int8>("/send_goal_pose/goal_index",100);
   ...
   moving_robot_commad_sub = nh.subscribe("/detect_and_recog/mov_robot_command", 10, movingRobotCommandCallback);
  ...
  MoveBaseClient action_goal("move_base", true); // false
  //
  initLandmarks();
