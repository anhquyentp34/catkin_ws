...
double_t landmarks_pose[N_GOALS][3] = {{1.03,5.0552,1.0}};
//double_t landmarks_pose[N_GOALS][3] = {{0.5,-0.5,-0.9849}}; // Tiến closed //,{2.0,-3.0,0.01},{3.8,-5.5,-PI2},{3.0,-7.0,-3*PI4},{3.8,-5.5,PI2},{3.8,-4.0,PI2},{4.2,-1.5,PI2-0.2},{-3.2,-4.0,PI},{-3.2,-1.0,PI2},{-4.1,1.6,2.2*PI4},
                                      // {-3.2,-1.0,-PI2},{-3.2,-4.0,PI},{-8.5,-4.0,PI},{-11.6,-5.0,-3*PI4},{-11.0,-6.0,PI2},{-13.0,-2.5,PI2},{-11.8,1.2,PI2},{-11.8,6.6,PI2},{-12.8,6.6,PI},{-15.0,6.6,3*PI4},
                                      // {-12.8,6.6,0.01},{-10.8,6.6,0.01},{-9.5,7.8,PI4/2},{-10.8,6.6,PI},{-12.8,9.7,PI},{-14.8,10.5,3*PI4},{-12.8,9.7,0.01},{-11.0,12.0,0.01},
                                      // {-9.6,12.8,-PI4/2}};
...
int main(int argc, char** argv)
{
  ...
  while(counter<= N_GOALS)
  {
      ...
      if(app_pose_client.call(srv))
      {
          ...
          {
              if((counter==3)||(counter==2)||(counter==15)){
                ...
                ROS_INFO("Update new goal [%d] (x, y, w) = (%f, %f, %f)",update_index.data,update_goal_pose.position.x,
                  ...
                  if(flag_dsz_appose){// if using the approaching goal pose estimation and prediction
